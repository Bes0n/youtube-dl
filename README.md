...
```
youtube-dl --username "yourmail@gmail.com" --password "pass" --verbose --sleep-interval 120 "https://app.pluralsight.com/library/courses/teamcity-getting-started" -o "~/TeamCity/%%(id)s-%%(title)s.%%(ext)s"  --playlist-start 1 --playlist-end 2
```
